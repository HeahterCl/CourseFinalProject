...
public class AddOnActivity extends AppCompatActivity {
    ...
    private ArrayList<String> timeKeywords = new ArrayList<String>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timeKeywords.add("123");
        timeKeywords.add("fdaf");
    ...
    private View getView1() {
        ...
        startSRButton.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private View getView2() {
        ...
        ListView listView = (ListView) view.findViewById(R.id.time_list_view);
        listView.setDividerHeight(0);
        listView.setAdapter(new BaseAdapter() {
            @Override
            public int getCount() {
                return timeKeywords.size();
            }

            @Override
            public Object getItem(int i) {
                return timeKeywords.get(i);
            }
            ...
            public View getView(int i, View view, ViewGroup viewGroup) {
                ...
                textView.setText(timeKeywords.get(i));
                return view;
            }
        });
